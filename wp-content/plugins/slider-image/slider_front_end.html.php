...
//                          var_dump($images);exit;
			  foreach ($images as $key => $image_row) {
				...
				switch($imagerowstype){
					case 'image':
					$target="";
                                        $alt_tag = explode("/",$image_row->image_url);
                                        $alt_tag = end($alt_tag);
                                        $alt_tag = explode(".",$alt_tag);
                                        $alt_tag = array_shift($alt_tag);
					?>
					  <li class="huge_it_slideshow_image<?php if ($i != $current_image_id) {$current_key = $key; echo '_second';} ?>_item_<?php echo $sliderID; ?>" id="image_id_<?php echo $sliderID.'_'.$i ?>">      
						...
						<img id="huge_it_slideshow_image_<?php echo $sliderID; ?>_<?php echo $key ;?>" class="huge_it_slideshow_image_<?php echo $sliderID; ?>" src="<?php echo $image_row->image_url; ?>"  alt="<?php if($image_row->name == "") echo $alt_tag;else echo $image_row->name; ?>" data-image_id="<?php echo $image_row->id; ?>" />
